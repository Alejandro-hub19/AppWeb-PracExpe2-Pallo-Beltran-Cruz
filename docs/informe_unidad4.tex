...
En el caso del SGED, la funcionalidad de escaneo de QR para asistencia es un candidato
natural para implementarse como PWA: el estudiante podría escanear su asistencia incluso
sin conexión y sincronizar con el servidor al recuperar señal.
Esta línea de trabajo se propone en la Sección~\ref{sec:futuro}.
...
\begin{itemize}
  \item \textbf{PWA para asistencia offline:} implementar un Service Worker en el frontend
    React del SGED que permita registrar asistencias sin conexión y sincronizar cuando el
    dispositivo recupere conectividad.
