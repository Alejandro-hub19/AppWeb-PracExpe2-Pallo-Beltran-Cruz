...
El 24 de julio un \textit{merge} reintrodujo los tokens en el cuerpo de la respuesta del login,
anulando la protección que la cookie \texttt{HttpOnly} existe para dar. Nadie lo notó, y esa fue
la versión que el docente evaluó; la observación nos llegó de vuelta como retroalimentación y yo
la corregí recién el 4 de agosto. Lo grave no es el \textit{merge}, eso pasa en cualquier equipo:
es que yo era el responsable de las pruebas y ninguna cubría la condición de la que dependía mi
propio diseño de seguridad. La suite ya superaba el umbral de cobertura que nos habíamos fijado,
y aun así nadie preguntaba lo más básico: ¿la respuesta del login trae un token?
